...
```python
# ✅ GOOD: Descriptive test names that explain the scenario and expected outcome
...
- test_login_with_expired_token_raises_unauthorized
- test_fetch_users_when_database_empty_returns_empty_list
```

## Keywords

pytest, python, testing, fixtures, mocking, parametrize, markers, AAA pattern, test naming